...
enum class TokenType {
    END_OF_FILE, IDENTIFIER, INTEGER_LITERAL, FLOAT_LITERAL, STRING_LITERAL,
    KW_SHONKHA, KW_DOSHOMIK, KW_SHOBDO, KW_JODI, KW_NAHOLE, KW_JOKHON,
    KW_LEHKHO, KW_INFOBRO, KW_CHOLO, KW_THAMVAI,
